...
const smokeMaterial = new THREE.ShaderMaterial({
    ...
    uniforms: {
        ...
        uSmokeColor: new THREE.Uniform(new THREE.Color(debugObject.color)
)
    },
...
gui.addColor(debugObject, 'color').onChange(() =>{
    smokeMaterial.uniforms.uSmokeColor.value.set(debugObject.color)
})
